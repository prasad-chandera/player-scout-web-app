...
export const MOCK_PLAYERS: Player[] = [
  ...
  },
  {
    ...
    matches: 96,
    readiness: 90,
    expectedPriceLakh: 420,
    expectedValueLakh: 520,
    tags: ["lightning glovework", "middle-overs anchor", "elite vs spin"],
    rawStats: { innings: 90, runs: 2410, ballsFaced: 1780, strikeRate: 135.4, boundaryPct: 0.17, dotBallPct: 0.31, catches: 78, stumpings: 21, runOuts: 9 },
    skillGroups: { batting: 0.82, bowling: 0.03, fielding: 0.9, pressure: 0.85, consistency: 0.8 },
    phaseStats: [
      { phase: "powerplay", strikeRate: 120.4, dotPct: 0.34 },
      { phase: "middle", strikeRate: 138.1, dotPct: 0.29 },
      { phase: "death", strikeRate: 158.6, dotPct: 0.22 },
    ],
    featureVector: [0.7, 0.86, 0.82, 0.84, 0.83, 0.8, 0.82, 0.85, 0.9, 0.8],
  },
  {
    id: "aryan-joshi",
    name: "Aryan Joshi",
    ...
    readiness: 79,
    expectedPriceLakh: 30,
    expectedValueLakh: 180,
    tags: ["quick hands behind the stumps", "aggressive powerplay bat", "small sample"],
    rawStats: { innings: 25, runs: 712, ballsFaced: 486, strikeRate: 146.5, boundaryPct: 0.2, dotBallPct: 0.3, catches: 29, stumpings: 8, runOuts: 4 },
    skillGroups: { batting: 0.7, bowling: 0.02, fielding: 0.82, pressure: 0.68, consistency: 0.6 },
    phaseStats: [
      { phase: "powerplay", strikeRate: 138.2, dotPct: 0.33 },
      { phase: "middle", strikeRate: 143.9, dotPct: 0.3 },
      { phase: "death", strikeRate: 160.4, dotPct: 0.24 },
    ],
    featureVector: [0.72, 0.7, 0.66, 0.74, 0.68, 0.66, 0.7, 0.68, 0.82, 0.58],
  },
];
